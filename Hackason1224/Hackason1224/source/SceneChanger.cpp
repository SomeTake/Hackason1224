...
void SceneChanger::DrawMask()
{
	...
	pDevice->DrawPrimitiveUP(D3DPT_TRIANGLESTRIP, NUM_POLYGON, vertexWkMask, sizeof(VERTEX_2D));
...
void SceneChanger::DrawChanger()
{
	...
	pDevice->SetFVF(FVF_VERTEX_2D);
	pDevice->DrawPrimitiveUP(D3DPT_TRIANGLESTRIP, NUM_POLYGON, vertexWkChange, sizeof(VERTEX_2D));
